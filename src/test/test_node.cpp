...
TEST(NodeTest, CopyConstructor)
{
  ...
  EXPECT_EQ(original.get_value(), "original_value"); // not changed
...
TEST(NodeTest, StringAssignmentOperator)
{
  ...
  EXPECT_EQ(node.get_line(), 0); // not changed
...
TEST(NodeTest, ConstCorrectness)
{
  ...
  // not valid
  // const_node.set_value("new_value");
  // const_node.set_line(1);;
  // const_node = "new_string";
}
